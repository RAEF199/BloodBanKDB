 ...
 * @author shere
 */
public class Examin_Donor extends javax.swing.JFrame {
...
//step3 create the statement object  
            ...
            String query = "Select Examin_DonorID from sys.EXAMIN_DONOR";
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Examin Donor Details");
        ...
        jLabel6.setText("Examin Donor ID");
        ...
        jLabel7.setText("Examin Donor name");
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addGroup(layout.createSequentialGroup()
                                        .addGap(18, 18, 18)
                                        .addComponent(press, javax.swing.GroupLayout.PREFERRED_SIZE, 140, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                        .addGap(16, 16, 16)
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addComponent(hemo, javax.swing.GroupLayout.PREFERRED_SIZE, 140, javax.swing.GroupLayout.PREFERRED_SIZE)
                                            .addComponent(pulse, javax.swing.GroupLayout.PREFERRED_SIZE, 140, javax.swing.GroupLayout.PREFERRED_SIZE)
                                            .addComponent(temp, javax.swing.GroupLayout.PREFERRED_SIZE, 140, javax.swing.GroupLayout.PREFERRED_SIZE))
                                        .addGap(2, 2, 2))))
                            .addGroup(layout.createSequentialGroup()
    ...
    private void List2ValueChanged(javax.swing.event.ListSelectionEvent evt) {//GEN-FIRST:event_List2ValueChanged
        ...
        try {
            ...
            //step3 create the statement object
            Statement stm = con.createStatement();
            String query = "Select Hemoglobin,pulse_rate, temperature,blood_pressure,examin_donorid from sys.EXAMIN_DONOR where examin_donorid= '" + List2.getSelectedValue() + "'";
            ResultSet rs = stm.executeQuery(query);
            while (rs.next()) {

                hemo.setText(rs.getString(1));
                pulse.setText(rs.getString(2));
                temp.setText(rs.getString(3));
                press.setText(rs.getString(4));
                id.setText(rs.getString(5));
            }
            String query1 = "SELECT FIRST_NAME FROM sys.DONOR d , sys.EXAMIN_DONOR ex  WHERE d.DONOR_ID = ex.EXAMIN_DONORID AND ex.EXAMIN_DONORID= '"+id.getText()+"' ";
    ...
    private void ADDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ADDActionPerformed
        ...
        try {
            ...
            //step3 create the statement object
            Statement stm = con.createStatement();
            int hemo1 = Integer.valueOf(hemo.getText());
            int temp1 = Integer.valueOf(temp.getText());
            int rate =  Integer.valueOf(pulse.getText());
            int press1 =  Integer.valueOf(press.getText());
            int id1 = Integer.valueOf(id.getText()); 
            
            String query = "insert into sys.EXAMIN_DONOR values (" +  hemo1 + "," + rate + "," + temp1+ "," + press1 +","+id1+")";
            stm.execute(query);
    ...
    private void DELETEActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DELETEActionPerformed
        ...
        try {
            ...
            //step3 create the statement object
            Statement stm = con.createStatement();
            int select = Integer.valueOf(List2.getSelectedValue());
            String query = "delete from sys.EXAMIN_DONOR where examin_donorid= "+select+"";
            stm.execute(query);
    ...
    private void UPDATEActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UPDATEActionPerformed
        ...
        try {
            ...
            int id1 = Integer.valueOf(id.getText());
            int select = Integer.valueOf(List2.getSelectedValue());
            String query = "update sys.EXAMIN_DONOR set Hemoglobin= "+hemo1+", Pulse_Rate= "+rate+", Temperature="+temp1+", Blood_Pressure= "+press1+", EXAMIN_DONORID= "+id1+" where examin_donorid= "+select;
            stm.execute(query);
...
////step3 create the statement object  
//            Statement stm = con.createStatement();
//            int donid = Integer.valueOf(id.getText());
//            String query = "SELECT FIRST_NAME FROM sys.DONOR d , sys.EXAMIN_DONOR ex  WHERE d.DONOR_ID = ex.EXAMIN_DONORID AND ex.EXAMIN_DONORID= '"+id.getText()+"' ";
//            ResultSet rs = stm.executeQuery(query);
//           
//            
//            while (rs.next()) {
//                 if(id.getText()!=null){
//                donorname.setText(rs.getString(1));
//                 }
//               // y.setText(rs.getString(1));
//            }
//             
...
*/
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Examin_Donor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Examin_Donor().setVisible(true);
            }
        });
    }
